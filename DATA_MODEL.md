...
| Date | Run | Summary |
|---|---|---|
| 2026-07-22 | `fix/35-shell-guard-bypass-followup` | Closed follow-up shell-guard bypasses: deny `GIT_CONFIG_*` env injection, peel Homebrew GNU `gtimeout`/`gnice`/`gstdbuf`/`gtime`, and structurally re-check high-impact basenames after unknown launchers. |
