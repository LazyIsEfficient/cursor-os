...
description: Standards for adversarial review of documents with formal or technical claims — math derivations, physics papers, statistical analyses, benchmark reports, whitepapers. Inventories every equation and quantitative claim, verifies each AS NAMED in text (never paraphrase or neighbor), classifies VERIFIED / REFUTED / UNVERIFIABLE / VACUOUS. Loaded inline when value collapses if an equation or number is wrong. Triggers on "check this paper", "verify these claims", "review this proof", "audit this benchmark", "does the math hold up". For dispatched review against cold-context brief — use adversarial-claims-reviewer agent. Not for auditing this plugin's component files against library rules — use library-investigator. Not for source-code review — use code-review-and-quality.
---
