...
- Sentiment (positive / neutral / negative ratio in conversations)
...
Paid + earned creator coverage. See `assets/community-program-template.md` for tier structure.

### Tier-1 (top creators in the genre)
- Direct outreach with custom keys
- Briefing call with developers
- Custom assets / demo builds
- Long-term relationship

### Tier-2 (mid-creators)
- Code drops via creator network
- Self-serve assets

### Tier-3 (community creators)
- Ambassador program: cosmetics for X views
- Affiliate codes

### Briefing influencers
- **Don't dictate** what they say — creators know their audience
- **Provide assets** — gameplay capture, branding, key art
- **Embargo timing** — coordinate launch coverage
- **Disclosure compliance** — paid relationships disclosed per FTC / per platform rules
...
- **PC indies:** PC Gamer, RPS, IGN, Eurogamer, Polygon
- **Mobile games:** Pocket Gamer, TouchArcade, AppShouter
- **Mid-core mobile:** mobile-specialist outlets + general games press
- **Web3 games:** crypto-specialist outlets + games press
- **Genre-specialist outlets** (RPGs, strategy, fighting games, etc.)
...
Coordinate with `iap-manager` for monetization issues; `security-engineering` for exploits / fraud; legal for regulatory issues.
