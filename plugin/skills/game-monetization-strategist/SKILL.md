...
description: "Use when picking and shaping game monetization model — premium / F2P / subscription / ad-supported / hybrid / web3 — including LTV / ARPDAU / ROAS targets, retention-to-monetization mapping, soft-launch KPI floors, macro economy. Triggers on \"monetization model\", \"monetization strategy\", \"F2P vs premium\", \"LTV\", \"ARPDAU\", \"ROAS\", \"soft launch KPIs\", \"battle pass\", \"subscription model\", \"web3 token economy\", or design doc with model still open. Produces monetization strategy doc, KPI floors, macro economy spec. Stops at strategy — no per-SKU prices (iap-manager), no economy number tuning (game-balancer). For per-SKU catalog see iap-manager; for economy curves see game-balancer; for CPI see game-marketer."
---
