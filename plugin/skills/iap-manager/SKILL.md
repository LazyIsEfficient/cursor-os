---
name: iap-manager
description: Use when designing and operating in-app purchase catalog of a game — SKU design, price-tier ladder, bundles, starter packs, battle pass tiering, A/B price tests, store config (App Store / Google Play / Steam DLC / web / web3), per-region price localization. Triggers on "IAP catalog", "store SKUs", "pricing tiers", "starter pack", "bundle design", "battle pass tiering", "price test", "price localization", "App Store Connect", "Google Play Console", "Steam DLC", or monetization strategy with catalog still open. Produces catalog spec, per-region price tables, bundle compositions, price-test plan. For the macro model and KPI floors see game-monetization-strategist; for in-game economy curves see game-balancer; for store-page conversion and trailers see game-marketer.
---
