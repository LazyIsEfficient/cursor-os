...
description: Protocol for forensic audit of this plugin's skill, agent, and rule surfaces — mechanical probe sequence over every component file against mechanically-checkable rules, reporting CONFORMS / VIOLATES / UNVERIFIABLE / N-A counts with quoted evidence. Casts NO judgment, emits NO pass/fail verdict; counts are the headline. Loaded inline when deliverable is a fact sheet of violations with proof, not quality opinion. Triggers on "investigate the library", "find every violation", "forensic library audit", "evidence-only check". For dispatched audit against cold-context brief — use library-investigator agent. Not for verifying equations or quantitative claims — use adversarial-claims-reviewer. Not for reviewing a code diff or quality opinion — use code-review-and-quality.
---
