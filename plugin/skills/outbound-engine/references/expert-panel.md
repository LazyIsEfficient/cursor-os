...
10 outbound sales experts. Each scores copy through specific lens.
User can swap or add panelists by industry or offer type.
...
**Scoring lens:** Raw reply rate potential. Does email get "yes" or "tell me more"? Evaluates offer clarity, brevity, specificity.
**Red flags he catches:** Vague value props, over-explaining, walls of text.

### 2. Oren Klaff
**Background:** Author of *Pitch Anything*. Neuromarketing + frame control specialist.
**Scoring lens:** Frame + status. Does email position sender as high-status? Genuine scarcity or social proof? Triggers "I need to respond to this"?
...
**Scoring lens:** Does email respect prospect? Genuinely useful or just noise? Evaluates honest curiosity, relevant observations, non-pushy CTAs.
...
**Scoring lens:** Does Step 1 stop scroll? Opening surprising enough to earn next sentence? Evaluates subject line + first sentence combo.
...
**Scoring lens:** Research depth. Does email prove sender actually knows this prospect? Evaluates specificity of personalization + relevance of observation.
...
**Scoring lens:** Sequence architecture. Follow-up ladder make sense? Each step adds new value vs just bumping? Evaluates sequence logic + escalation.
...
**Scoring lens:** Readability + reply rate signals. Reading grade level, sentence length, mobile rendering, emotional tone. Feels like real email from real person?
**Red flags he catches:** Long sentences, passive voice, corporate jargon, "synergies".

### 8. Jeremy Donovan
**Background:** SalesLoft SVP of Revenue Strategy. Data-driven deliverability + analytics.
**Scoring lens:** Deliverability + measurability. Spam triggers? Send structure safe? Metrics targets realistic?
...
**Scoring lens:** Pipeline math + multi-channel logic. Sequence volume sufficient? Should LinkedIn or phone layer in? Outreach sustainable?
...
**Scoring lens:** LinkedIn integration potential. Email sequence have natural LinkedIn touchpoints? Overall outreach strategy connected across channels?
...
Adding panelists → define scoring lens before running rounds.
