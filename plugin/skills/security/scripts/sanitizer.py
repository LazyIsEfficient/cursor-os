...
Usage:
    python3 plugin/skills/security/scripts/sanitizer.py --scan --file path/to/file.py
    python3 plugin/skills/security/scripts/sanitizer.py --scan --dir . --recursive
    python3 plugin/skills/security/scripts/sanitizer.py --sanitize --file path/to/file.py
"""
...
Examples:
  ...
  %(prog)s --scan --dir . --recursive --config plugin/skills/security/scripts/sanitizer-config.json
        """,
    )
    ...
    parser.add_argument("--config", type=str, help="Path to config JSON (default: plugin/skills/security/scripts/sanitizer-config.json)")
